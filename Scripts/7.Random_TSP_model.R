...
for( i in 1:1000){
  meta_auc[[i]] = combine.est(c(icgc_list[[2]][i], tcga_list[[2]][i], moff_list[[2]][i], zhang_list[[2]][i],winter_list[[2]][i], ouh_list[[2]][i]), c( icgc_list[[3]][i], tcga_list[[3]][i], moff_list[[3]][i], zhang_list[[3]][i], winter_list[[3]][i], ouh_list[[3]][i]),na.rm=TRUE)$estimate
  seq_auc[[i]] = combine.est(c(icgc_list[[2]][i], tcga_list[[2]][i]), c( icgc_list[[3]][i], tcga_list[[3]][i]),na.rm=TRUE)$estimate
  microarray_auc[[i]] = combine.est(c( moff_list[[2]][i], zhang_list[[2]][i],winter_list[[2]][i], ouh_list[[2]][i]), c( moff_list[[3]][i], zhang_list[[3]][i], winter_list[[3]][i], ouh_list[[3]][i]),na.rm=TRUE)$estimate
