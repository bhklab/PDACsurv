...
# easyGgplot2/R/utilties.R ------------------------------------------------

#' Credit for this code goes to Alboukadel Kassambra and is extracted
#' from the easyGGplot2 package
...
# easyGgplot2/R/ggplot2.customize.R -------------------------------------
...
# easyGgplot2/R/ggplot2.setAxis.R -----------------------------------------
