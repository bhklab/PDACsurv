...
#' @return A \code{} 
#'
#' @import switchBox vcdExtra caret forestplot ktspair pROC survcomp survival
#' @import data.table reportROC devtools easyGgplot2
#'
#' @importFrom switchBox 
#' @export
randomGeneAssignmentModel <- function(data) {
  ...
  merge_common_mat <- data.matrix(sapply(xmat, 
                                         function(xx) 
