...
PCOSPstats <- constructMetaEstimatesDF(PCOSPscores[names(cohortSurvivalData)], 
                                       cohortSurvivalData, 
                                       seqCohorts)


birnbaumStats <- constructMetaEstimatesDF(birnbaumScores[names(cohortSurvivalData)], 
                                          cohortSurvivalData, 
                                          seqCohorts)

chenStats <- constructMetaEstimatesDF(chenScores[names(cohortSurvivalData)], 
                                      cohortSurvivalData, 
                                      seqCohorts)

haiderStats <- constructMetaEstimatesDF(haiderScores[names(cohortSurvivalData)], 
                                        cohortSurvivalData, 
                                        seqCohorts)
